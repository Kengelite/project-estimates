...
type Course struct {
	...
	Structures            []CourseStructure      `gorm:"foreignKey:CourseID;references:ID" json:"structures"`
	SubjectOutsideDeducts []SubjectOutsideDeduct `gorm:"foreignKey:CourseID;references:ID" json:"subjectOutsideDeducts"`
	Students              []CourseStudent        `gorm:"foreignKey:CourseID;references:ID" json:"students"`
