...
type UniversityWorkSplit struct {
	...
	UniversityWorkID uuid.UUID      `gorm:"type:char(36);not null;index:idx_university_work_split_group,unique" json:"universityWorkId"`
	UniversityWork   UniversityWork `gorm:"foreignKey:UniversityWorkID;references:ID" json:"universityWork"`
	SplitGroupID     uuid.UUID      `gorm:"type:char(36);not null;index:idx_university_work_split_group,unique" json:"splitGroupId"`
