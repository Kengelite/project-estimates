...
export default function DeleteDeptModal({ item, onClose, onConfirm }: DeleteDeptModalProps) {
  return (
    <ModalBase onClose={onClose}>
      ...
      <p className="text-sm text-gray-500 mb-4">คุณต้องการลบข้อมูลส่วนกลางวิทยาลัยนี้ใช่หรือไม่?</p>

      <div className="bg-gray-50 rounded-xl px-4 py-3 mb-3 text-sm space-y-1.5">
        <p><span className="text-gray-400">ชื่อส่วนกลาง : </span><span className="text-gray-700">{item.name}</span></p>
