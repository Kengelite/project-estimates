...
export default function CentralDeptManagement() {
  ...
  const handleDelete = (id: number) => {
    if (!confirm("ต้องการลบส่วนกลางนี้ใช่หรือไม่?")) return;
            ...
            <div className="p-4 border-b border-gray-100">
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="ค้นหาชื่อส่วนกลางวิทยาลัย..."
                ...
                <thead>
                  <tr className="bg-gray-100 border-b border-gray-200">
                    {[
                      ...
                      <th
                        key={h}
                        className="text-center px-5 py-3 text-xs font-semibold text-gray-600 whitespace-nowrap"
                      >
                        {h}
                      </th>
                    ))}
