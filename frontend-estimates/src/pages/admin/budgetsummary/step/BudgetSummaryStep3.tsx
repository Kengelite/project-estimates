...
export default function BudgetSummaryStep3() {
  ...
  const currentStep = 2; // Step 3 (Index 2)
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex flex-1 px-6 pb-24 max-w-[1400px] w-full mx-auto gap-8">
        ...
        <div className="flex-1">
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8 space-y-8">
            <h2 className="text-[17px] font-bold text-gray-900">รายละเอียดการจ่ายให้เจ้าของรายวิชานอกคณะ</h2>
              ...
              <table className="w-full text-sm text-gray-700">
                <thead>
                  <tr className="border-b border-gray-200">
                    ...
                    <th className="py-4 px-2 text-right font-semibold">จ่ายให้รายวิชานอกคณะ</th>
                ...
                <tbody>
                  {/* Group Header */}
                  <tr>
                    <td colSpan={4} className="py-4 px-2 text-gray-500">ปริญญาตรี (ปกติ)</td>
                  </tr>
                  {/* Rows */}
                  <tr className="border-b border-gray-100">
                    <td className="py-4 px-2 font-medium">IT (ปกติ)</td>
                    <td className="py-4 px-2 text-right">7,912,500</td>
                    <td className="py-4 px-2 text-right text-red-500">-569,250</td>
                    <td className="py-4 px-2 text-right text-blue-600">7,343,250</td>
                  </tr>
                  <tr className="border-b border-gray-200">
                    <td className="py-4 px-2 font-medium">CS (ปกติ)</td>
                    <td className="py-4 px-2 text-right">8,750,000</td>
                    <td className="py-4 px-2 text-right text-red-500">-630,135</td>
                    <td className="py-4 px-2 text-right text-blue-600">8,119,865</td>
                  </tr>
                  {/* Summary Row */}
                  <tr className="font-bold bg-gray-50/50">
                    <td className="py-4 px-2">รวม</td>
                    <td className="py-4 px-2 text-right">16,662,500</td>
                    <td className="py-4 px-2 text-right text-red-500">-1,199,385</td>
                    <td className="py-4 px-2 text-right text-blue-600">15,463,115</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="space-y-4 pt-4">
              <div className="flex items-center justify-between bg-gray-50 rounded-xl px-6 py-5">
                <span className="font-semibold text-gray-800">รวมเงินจ่ายให้เจ้าของรายวิชานอกคณะ</span>
                <span className="text-lg font-bold text-red-500">-1,199,385 บาท</span>
              </div>
              <div className="flex items-center justify-between bg-gray-50 rounded-xl px-6 py-5">
                <span className="font-semibold text-gray-800">คงเหลือทั้งหมด</span>
                <span className="text-lg font-bold text-blue-600">15,463,115 บาท</span>
              </div>
            </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 px-8 flex justify-end gap-3 z-40">
        <button onClick={() => navigate("/annual-budget-summary/step2")} className="px-8 py-2.5 rounded-xl border border-gray-300 text-gray-700 font-medium text-sm hover:bg-gray-50 transition-colors">
          ย้อนกลับ
        </button>
        <button onClick={() => navigate("/annual-budget-summary/step4")} className="px-10 py-2.5 rounded-xl bg-blue-600 text-white font-medium text-sm hover:bg-blue-700 transition-colors shadow-sm">
          ถัดไป
        </button>
      </div>
    </div>
