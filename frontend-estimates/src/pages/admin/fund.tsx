...
const INITIAL_DATA: FundItem[] = [
  {
    id: 1,
    name: "อุดหนุนการบริหารและพัฒนามหาวิทยาลัย",
    percent: "3%",
    active: true,
  },
  {
    id: 2,
    name: "กองทุนพัฒนาอาจารย์/บุคลากรและการวิจัย ระดับมหาวิทยาลัย",
    percent: "1%",
    active: true,
  },
  {
    id: 3,
    name: "กองทุนพัฒนาอาจารย์/บุคลากรและการวิจัย ระดับคณะ/หน่วยงาน",
    percent: "1%",
    active: true,
  },
  ...
  {
    id: 5,
    name: "สมทบจ่ายค่าสาธารณูปโคและพัฒนาระบบกายภาพ",
    percent: "5%",
    active: true,
  },
  ...
  {
    id: 8,
    name: "ค่าบำรุงรักษาอุปกรณ์และสิ่งอำนวยความสะดวก",
    percent: "3%",
    active: true,
  },
  ...
  {
    id: 10,
    name: "ทุนฉุกเฉินและสวัสดิการบุคลากร",
    percent: "1%",
    active: true,
  },
  {
    id: 11,
    name: "กองทุนส่งเสริมกิจกรรมนักศึกษา",
    percent: "2%",
    active: false,
  },
  {
    id: 12,
    name: "ค่าพัฒนาระบบสารสนเทศมหาวิทยาลัย",
    percent: "1%",
    active: true,
  },
];
              ...
              <thead>
                <tr className="bg-gray-100 border-b border-gray-200">
                  {[
                    ...
                    <th
                      key={h}
                      className={`px-5 py-3 text-xs font-semibold text-gray-600 whitespace-nowrap ${h === "ชื่อกองทุน" ? "text-left" : "text-center"}`}
                    >
                      {h}
                    </th>
                  ))}
              ...
              <tbody className="divide-y divide-gray-100">
                {paginated.length === 0 ? (
                  ...
                  paginated.map((row, i) => (
                    ...
                    >
                      <td className="px-5 py-4 text-center text-gray-500 w-16">
                        {(page - 1) * pageSize + i + 1}
                      </td>
                      <td className="px-5 py-4 text-gray-800">{row.name}</td>
                      <td className="px-5 py-4 text-center text-gray-700 w-40">
                        {row.percent}
                      </td>
